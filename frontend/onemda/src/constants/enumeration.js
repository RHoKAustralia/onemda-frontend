...
export const LearningCategories = [
  {'value': '', 'label': 'Select one'},
  {'value': 'Collingwood Farm', 'label': 'Collingwood Farm'},
  {'value': 'Girl Talk', 'label': 'Girl Talk'},
  {'value': 'Craft/Art', 'label': 'Craft/Art'},
  {'value': 'Scrapbooking', 'label': 'Instrument making'},
  {'value': 'life skills', 'label': 'life skills'},
  {'value': 'theatre sports', 'label': 'theatre sports'},
  {'value': 'travel training', 'label': 'travel training'},
  {'value': 'Stephanie Alexander', 'label': 'Stephanie Alexander'},
  {'value': 'ACFE - Gardening', 'label': 'ACFE - Gardening'},
  {'value': 'paper round', 'label': 'paper round'},
  {'value': 'cooking', 'label': 'cooking'},
  {'value': 'armchair travel', 'label': 'armchair travel'},
  {'value': 'language literacy numeracy', 'label': 'language literacy numeracy'},
  {'value': 'proloquo2go', 'label': 'proloquo2go'},
  {'value': 'DJ flash', 'label': 'DJ flash'},
